...
def client(google_settings):
    with patch("loombit_operator.routers.skill_blanca_oauth.get_settings", return_value=google_settings):
        with patch("loombit_operator.skill_blanca_oauth.get_settings", return_value=google_settings):
...
def test_start_returns_authorization_url(client):
    with patch("loombit_operator.routers.skill_blanca_oauth.get_settings") as mock_cfg, \
         patch("loombit_operator.routers.skill_blanca_oauth.oauth_configs_from_settings") as mock_cfgs, \
...
def test_start_returns_403_when_disabled():
    ...
    with patch("loombit_operator.routers.skill_blanca_oauth.get_settings"), \
         patch("loombit_operator.routers.skill_blanca_oauth.oauth_configs_from_settings",
...
def test_status_returns_snapshot(tmp_path):
    ...
    with patch("loombit_operator.routers.skill_blanca_oauth.get_settings"), \
         ...
         patch("loombit_operator.routers.skill_blanca_oauth.oauth_readiness",
