...
**D-32 — Frente 2: fiabilidad del agente (anti-flailing + no re-pausa muda).** Estado **🟡** (construido en rama `feat/fiabilidad-agente`, 11 tests; NO auto-desplegado — toca el núcleo `loop.py`, espera OK de Fernando para fundir). Sale de Investigación 6.
