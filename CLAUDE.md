...
| `docs/ROADMAP_INTEGRACION_PLATAFORMA.md` | **HUB para otro hilo**: cómo integrar el trabajo de plataforma/skills en el roadmap (encaje por fases), catálogo COMPLETO de ~80 skills priorizado, upgrades de núcleo (K1-K11), índice de documentación, índice del radar y agenda de investigación futura |
