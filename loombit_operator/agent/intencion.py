...
def fuerza_tool(task: str) -> bool:
    """True si la petición es CONSECUENTE (cobro/303/factura): hay que forzar la herramienta
    determinista para que el modelo no calcule ni fabrique cifras a ojo."""
    t = (task or "").lower()
    return bool(_COBRO.search(t) or _F303.search(t) or _FACTURA.search(t))
